...
////////// Segway
/obj/item/mecha_parts/chassis/segway_frame
	name = "Segway Frame"
	icon_state = "segway_frame"
	construction_cost = list("metal"=15000)
	New()
		..()
		construct = new /datum/construction/mecha/segway_assembly(src)

/obj/item/mecha_parts/part/segway_wheel_left
	name="Left Segway Wheel"
	icon_state = "segway_wheel_left"
	origin_tech = "engineering=1"
	construction_time = 60
	construction_cost = list("metal"=5000)

/obj/item/mecha_parts/part/segway_wheel_right
	name="Right Segway Wheel"
	icon_state = "segway_wheel_right"
	origin_tech = "engineering=1"
	construction_time = 60
	construction_cost = list("metal"=5000)


/obj/item/mecha_parts/part/segway_handlebars
	name="Segway Handlebars"
	icon_state = "segway_handlebars"
	origin_tech = "engineering=1"
	construction_time = 60
	construction_cost = list("metal"=5000)
