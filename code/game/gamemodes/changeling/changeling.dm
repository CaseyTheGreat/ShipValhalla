...
/datum/game_mode/changeling
	...
	var
		const
			...
			var/const/changeling_scaling_coeff = 5.0
			var/const/changeling_absorb_coeff = 5.0
			var/changeling_amount = 1.0
...
/datum/game_mode/changeling/pre_setup()
	...
	changeling_amount = max(1, round((num_players())/(changeling_scaling_coeff)))
...
/datum/game_mode/proc/forge_changeling_objectives(var/datum/mind/changeling)
	...
	absorb_objective.gen_amount_goal(1,round(num_players()/2))
