...
*/
		...
		slitherweedextract
			name = "Slitherweed Extract"
			id = "slitherweedextract"
			description = "A compound extracted from the rare Slitherweed of the deserts on Ophidion IV"
			reagent_state = LIQUID
			color = "#006600"
			...
			on_mob_life(var/mob/living/carbon/human/M as mob)
				...
				M.mutantrace = "lizard"
				M.Paralyse(5)
				M << "\red You feel your spine nearly double in length as you sprout a tail! Razor sharp scales emerge from the surface of your skin!"
				holder.remove_reagent(src.id, 0.2)
				return
