...
/obj/item/seeds/slitherweedseed
	name = "Slitherweed seeds"
	desc = "Painstakingly extracted from mature Slitherweed plants on a distant desert planet."
	icon_state = "seed-slitherweed"
	mypath = "/obj/item/seeds/slitherweedseed"
	species = "slitherweed"
	plantname = "Slitherweed"
	productname = "/obj/item/weapon/reagent_containers/food/snacks/grown/slitherweedfrond"
	lifespan = 20
	endurance = 15
	maturation = 10
	production = 10
...
/obj/item/weapon/reagent_containers/food/snacks/grown/slitherweedfrond
	seed = "/obj/item/seeds/slitherweedseed"
	name = "Slitherweed Frond"
	desc = "Scaly!"
	icon_state = "slitherweedfrond"
	potency = 25
	New()
		..()
		reagents.add_reagent("slitherweedextract", 1+round((potency / 10), 1))
		bitesize = 1+round(reagents.total_volume / 2, 1)
